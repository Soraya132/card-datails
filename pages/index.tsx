...
export default function Home() {
  ...
  const formik = useFormik({
    ...
    validationSchema:Yup.object({
      ...
      year:Yup.number().required("can't be blank").max(30," year can't be more than 30").min(23," year can't be less than 23").typeError("wrong format, only numbers"),
  ...
  return (
    <div className='max-w-7xl flex justify-center items-center'>
      ...
      <main className='pb-32 lg:px-10 gap-y-[280px] bg-[url("/bg-main-mobile.png")] bg-no-repeat h-screen bg-contain w-full relative bg-top px-3  md:bg-[url("/bg-main-desktop.png")]  md:bg-left flex flex-col md:flex-row justify-between'>
    ...
    <form className='grid md:gap-5 lg:gap-7 gap-6 font-semibold text-sm uppercase' onSubmit={formik.handleSubmit}>
           ...
           <label className='block pb-1 text-Verydarkviolet uppercase' htmlFor='card'>
            ...
            <div className='grid grid-cols-2  pb-10 md:pb-0 lg:w-[90%] gap-2 '>
             ...
             <button type="submit" className='w-full text-white bg-Verydarkviolet text-White p-2 rounded lg:w-[90%] text-md'>Confirm</button>
           </form>
    </section>
  </main>
  </div>
